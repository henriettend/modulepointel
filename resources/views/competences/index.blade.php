        ...
        @forelse($competences as $competence)
          <tr>
            ...
            <td class="text-center">
              ...
              <a href="{{ route('competences.show', $competence->id) }}" class="btn btn-sm btn-info me-1">Détails</a>

              <form action="{{ route('competences.destroy', $competence->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Voulez-vous vraiment supprimer cette compétence ?');">
                @csrf
                @method('DELETE')
