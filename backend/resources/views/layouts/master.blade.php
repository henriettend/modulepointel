...
<head>
    ...
    <title>Module Gestion Evaluation Pointel</title>
...
<a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <ul class="nav navbar-nav flex-row">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Tableau de bord</span><span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span></a>
  ...
  <a class="d-flex align-items-center" href="{{ route('evaluations.index') }}">
    ...
    <span class="menu-title text-truncate" data-i18n="Evaluation">Évaluations</span>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('grilleEvaluation.index')}}"><i data-feather="save"></i><span class="menu-title text-truncate" data-i18n="File Manager">Grille d'évaluation</span></a>
                </li>
                
<li class="nav-item">
 
  <li class="nav-item">
    <a class="d-flex align-items-center" href="{{ route('competences.index') }}">
        <i data-feather="briefcase"></i> 
        <span class="menu-title text-truncate" data-i18n="File Manager">Compétences</span>
    </a>
</li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('criteres_evaluation.index')}}"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Pages">Critère évaluation</span></a>
                    <li>
    <a class="d-flex align-items-center" href="{{ route('objectifs.creation') }}">
        <i data-feather="target"></i> 
        <span class="menu-item text-truncate" data-i18n="Profile">Objectif évaluation</span>
    </a>
</li>

<li>
    <a class="d-flex align-items-center" href="{{ route('type_evaluations.index') }}">
        <i data-feather="layers"></i>
        <span class="menu-item text-truncate" data-i18n="FAQ">Type d'évaluation</span>
    </a>
</li>
    ...
    <a class="d-flex align-items-center" href="page-knowledge-base.html">
        ...
        <span class="menu-item text-truncate" data-i18n="Knowledge Base">Note</span>
    </a>
</li>
...
<li>
    <a class="d-flex align-items-center" href="#">
        ...
        <span class="menu-item text-truncate" data-i18n="Pricing">Historique des évaluations</span>
    </a>
</li>
